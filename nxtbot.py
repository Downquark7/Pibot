...
overturn_gain = input("overturn gain")
accumulated_gain = input("accumulated gain")
turn_error = 0
accumulated_turn = 0
...
while True:
    try:
        ...
        if not found:
            ...
            print ((((area/(h*w)) * direction*turn_gain) * 2) / w), ((accumulated_turn * 2) / w), ((-turn_error * overturn_gain * 2) / w)
