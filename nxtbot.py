...
while True:
    try:
        ...
        lower_pink = np.uint8([ac_clamp(target[0]-5),ac_clamp(target[1]-50),ac_clamp(target[2]-50)])
        upper_pink = np.uint8([ac_clamp(target[0]+5),ac_clamp(target[1]+50),ac_clamp(target[2]+50)])
